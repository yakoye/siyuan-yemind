...
Original skill name: `writing-plans`
Original trigger description: Use when you have a spec or requirements for a multi-step task, before touching code
...
5. Make the verification and documentation steps concrete enough that `superpowers-executing-plans` can follow them without guessing.
