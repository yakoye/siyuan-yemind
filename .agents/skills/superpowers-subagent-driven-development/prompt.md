...
Original skill name: `subagent-driven-development`
Original trigger description: Use when executing implementation plans with independent tasks in the current session
