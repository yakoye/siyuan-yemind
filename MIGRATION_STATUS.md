...
- Existing map, settings and checkpoint files require no v0.9.6 schema migration.
- The previous outline mode preference remains ignored because v0.9.6 keeps one unified outline surface; map content is unchanged.
