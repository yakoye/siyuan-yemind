...
with sync_playwright() as p:
    ...
    if neutral_guides or compact(tree_shape(page)) != initial_compact:
    ...
    if any(item['stroke'] == '#176b50' and not item['dash'] for item in child_guides) or not any(item['dash'] == '6 6' for item in child_guides):
