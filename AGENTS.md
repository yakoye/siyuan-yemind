...
3. One editing surface owns focus at a time: canvas or outline.
4. Text-editing shortcuts have priority over structural shortcuts while a Quill editor is active.
