...
本文件是 YeMind Zen 的项目级开发入口。所有后续开发以 **v0.5.20** 为当前稳定基线，并结合 `.agents/skills/superpowers-*` 中的 Superpowers skills 执行。
...
- 显示名称：`YeMind Zen`
- 当前开发基线：`v0.5.20`
- 不得回退或破坏 v0.5.10 至 v0.5.20 已完成的稳定性修复与交互契约。
...
- 输出包名称必须包含明确版本和用途，例如：`siyuan-yemind-zen-v0.5.20-dev.zip`。
