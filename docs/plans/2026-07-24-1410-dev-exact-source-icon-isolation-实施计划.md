...
- Modify: `AGENTS.md`
- Create: `docs/archive/v0.9/verifications/2026-07-24-1410-v0.9.22-版本-验证记录.md`
- Create: `docs/archive/v0.9/manifests/2026-07-22-1145-v0.9.22-版本-构建清单.json`
...
Write exact commands, exit codes, counts and manual SiYuan-only checks into `docs/archive/v0.9/verifications/2026-07-24-1410-v0.9.22-版本-验证记录.md`.
