...
**Files:**
- Create: `docs/releases/dev/2026-07-27-1110-dev-web-v1-验证记录.md`
- Modify: `README.md`
...
`README.md` 和 `README_zh_CN.md` 增加网页版启动、构建、数据位置、导入导出和部署说明。`docs/releases/dev/2026-07-27-1110-dev-web-v1-验证记录.md` 记录自动与人工浏览器结果。

- [ ] **Step 5: 提交、推送和部署**

```bash
git add README.md README_zh_CN.md docs/releases/dev/2026-07-27-1110-dev-web-v1-验证记录.md
